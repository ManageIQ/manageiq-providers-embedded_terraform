class ApplicationHelper::Toolbar::EmbeddedTerraformCredentialsCenter < ApplicationHelper::Toolbar::Basic
  button_group('embedded_terraform_credentials', [
                 select(
                   :embedded_terraform_credentials_configuration,
                   nil,
                   t = N_('Configuration'),
                   t,
                   :items => [
